...
const CompareFormations = (props: CompareFormationsProps) => {
    ...
    const girlBoyProportionData = comparedSchools.map((schoolID) => { 
        ...
        "count_candidates_boys": getField(s, 'voe_tot') - getField(s, 'voe_tot_f'),
    ...
    return (
        <div className="pcs-compareFormations-fragment">
            ...
            {comparedSchools.map((school) => <div>{school}</div>)}
            <h1 className="pcs-compareFormations-title">Comparaisons des formations</h1>
            <div className="pcs-compareFormations-main">
                Ici le contenu de comparaison
            </div>
            <div className="pcs-formationinfo-statscard-wrapper">
                <CompareGirlBoyProportion data={girlBoyProportionData} title={'Proportion de candidates / candidats'} />
            </div>
        </div>
    )
}
